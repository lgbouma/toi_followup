...
Look for TIC ID alert matches in:
    ...
    * Kraus_14_table_2_TucanaHorologiumMG_members_TIC_3arcsec_crossmatch_MAST.csv
...
def crossmatch_alerts(ticidlist_path, sector_id=0, find_alerts_in_MWSC=True):
    ...
    if find_alerts_in_MWSC:
        ...
        searchfiles = np.append(searchfiles,
                    glob(mtxdir+'????_*_1sigma_members_TIC_crossmatched.csv'))
...
if __name__ == '__main__':
    ...
    find_alerts_in_MWSC = True # NOTE: are you checking MWSC too?
